...
public enum SquareType {
  BLANK, FLAG, MINE, HITMINE, WRONGMINE, ZERO(0), ONE(1), TWO(2), THREE(3), FOUR(4), FIVE(5), SIX(6), SEVEN(
      7), EIGHT(8);
  ...
  public static SquareType of(int numMines) {
    checkArgument(numMines >= 0 && numMines <= 8, "numMines (%d) is out of bounds", numMines);
